		...
		function processAddress() {
			...
			function parseAddressLines() {
				...
				function getBestLocationString() {
					...
					regExp = /^(R*P*H*,?u{0,2},?)(?:(?:(p?)([Dnx]+?(?:t?n+)?)(t?f?)(&)(p?)([Dnx]+?(?:t?n+)?)(t?f?))|(?:(n*p?)([Dnx]+?(?:t?n+)?)(t?n?f?)))??(?:(,?u{0,2},?P*,?))(x*)(,?S*,?Z*,?C*)$/;
				...
				function replaceUnknowns() {
					var matchesRegExp = /^(R*P*H*,?u{0,2},?)(?:(?:(p?)([Dnx]+?(?:t?n+)?)(t?f?)(&)(p?)([Dnx]+?(?:t?n+)?)(t?f?))|(?:(n*p?)([Dnx]+?(?:t?n+)?)(t?n?f?)))??(?:(,?u{0,2},?P*,?))(x*)(,?S*,?Z*,?C*)$/;
					var matches;
					var numx, i;
					var xReplacement;
