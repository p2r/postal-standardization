		...
		function processAddress() {
			...
			function parseAddressLines() {
				...
				function getBestLocationString() {
					...
					regExp = /^(R*P*H*,?u{0,2},?)(?:(?:(p?)([nx]+?(?:t?n+)?)(t?f?)(&)(p?)([nx]+?(?:t?n+)?)(t?f?))|(?:(n*p?)([nx]+?(?:t?n+)?)(t?n?f?)))??(?:(,?u{0,2},?P*,?))(x*)(,?S*,?Z*,?C*)$/;
				...
				function replaceUnknowns() {
					...
					matchesRegExp = /^(R*P*H*,?u{0,2},?)(?:(?:(p?)([nx]+?(?:t?n+)?)(t?f?)(&)(p?)([nx]+?(?:t?n+)?)(t?f?))|(?:(n*p?)([nx]+?(?:t?n+)?)(t?n?f?)))??(?:(,?u{0,2},?P*,?))(x*)(,?S*,?Z*,?C*)$/;
