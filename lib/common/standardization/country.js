( function () {
	...
	module.exports = function ( country ) {
		...
		// console.info( "Country check: " + cleanCountry );
		...
		switch ( cleanCountry ) {
			...
			case "COTEIVOIRE":
			case "IVORY COAST":
			case "REPUBLIC OF COTE DIVOIRE":
			case "REP OF COTE DIVOIRE":
			case "REPUBLIC COTE DIVOIRE":
			case "REP COTE DIVOIRE":
			case "REPUBLIC OF COTE DIVOIRE":
			case "REP OF COTE DIVOIRE":
			case "REPUBLIC COTE DIVOIRE":
			case "REP COTE DIVOIRE":
			...
			case "KOREA, DEMOCRATIC PEOPLES REP OF":
			case "KOREA, DEM PEOPLES REPUBLIC OF":
			case "KOREA, DEM PEOPLES REP OF":
