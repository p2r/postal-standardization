( function () {
	...
	Standardization.prototype.streetTypes = require( "./streetType");
	Standardization.prototype.streetPrefix = require( "./streetPrefix");
	Standardization.prototype.streetSuffix = require( "./streetSuffix");
	Standardization.prototype.country = require( "./country");
	Standardization.prototype.fips = require( "./fipsStateCodes");
	Standardization.prototype.parse = require( "./parse");
