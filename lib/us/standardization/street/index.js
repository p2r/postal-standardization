	...
	module.exports = {
		parse: function ( streetString ) {
			...
			while ( !potentialMatch && words.length ) {
				potentialMatch = streetNumber( words.join( " " ) );
				if ( potentialMatch ) {
			...
			if ( street.number ) {
				...
				while ( !potentialMatch && words.length ) {
					potentialMatch = streetSuffix( words.join( " " ) );
					if ( potentialMatch ) {
				...
				while ( !potentialMatch && words.length ) {
					potentialMatch = streetPrefix( words.join( " " ) );
					if ( potentialMatch ) {
				...
				while ( !potentialMatch && words.length ) {
					potentialMatch = streetType( words.join( " " ) );
					if ( potentialMatch ) {
